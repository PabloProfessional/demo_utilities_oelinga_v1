...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">{{$tenant->unit->property->property_group->name}} - Group Dashboard</a></li>
                <li class="breadcrumb-item"><a href="/property/{{$tenant->unit->property->id}}">{{$tenant->unit->property->name}}</a></li>
                <li class="breadcrumb-item"><a href="/property_unit/{{$tenant->unit->id}}">{{$tenant->unit->name}}</a></li>
                <li class="breadcrumb-item active">Tenant | {{$tenant->user->name}}</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                   ...
                   <div class="row">
                       ...
                       <div class="col-xxl-4 col-md-6 oe_card">
                           <div class="card info-card sales-card ">
                               ...
                               <div class="card-body">
                                   <h5 class="card-title">Utilities <span>| outstanding total bill</span></h5>
                       ...
                       <div class="col-xxl-4 col-md-6 oe_card">
                           <div class="card info-card sales-card">
                               ...
                               <div class="card-body">
                                   <h5 class="card-title">Tenant<span> | details</span></h5>
                                   ...
                                   <div class="d-flex align-items-center">
                                       ...
                                       <div class="ps-3">
                                           <h6></h6>
                                           <span class="text-danger small pt-1 fw-bold"><a href="mailto:{{$tenant->user->email}}">{{$tenant->user->email}}</a> </span> <span class="text-muted small pt-2 ps-1">lease end date: <bold>12th Dec 2022</bold></span>
                  ...
                  <div class="col-12">
                      <div class="card top-selling">
                          ...
                          <div class="card-body pb-0">
                              <h5 class="card-title">{{$propertyUnit->name}} metres <span>| Year to date</span></h5>
                              ...
                              <table class="table table-borderless">
                                  ...
                                  <tbody>
                                @foreach($propertyUnit->metre as $metre)
                                      <tr>
                                          <th scope="row"><a href="/property_unit_metre/{{$metre->id}}"><img src="assets/img/metres/water_sample.jpg" alt="">{{$metre->name}}</a></th>
                                          <td><span class="badge badge-water">{{$metre->metre_type->name}}</span></td>
                                          <td class="fw-bold">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless datatable">
                             ...
                             @foreach($property->unit as $unit)
                                    <tr>
                                        <th scope="row"><a href="/property/unit/{{$unit->id}}">{{$unit->name}}</a></th>
                                        <td>
                            ...
                            document.addEventListener("DOMContentLoaded", () => {
                                echarts.init(document.querySelector("#trafficChart")).setOption({
                                        ...
                                        series: [{
                                            ...
                                            data: [{
                                                value: {{$water['water_cost']}},
                                                name: 'Water',
                                                color: '#343c54',
                                            },
                                                {
                                                    value: {{$electricity['electricity_cost']}},
                                                    name: 'Electricity'
                                                },
