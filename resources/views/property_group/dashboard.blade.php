...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>{{$propertyGroup->name}}</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                <li class="breadcrumb-item active">{{$propertyGroup->name}} - Group Dashboard</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6 ">
                        <div class="card info-card sales-card oe_card">
                    ...
                    <!-- Revenue Card -->
                    <div class="col-xxl-4 col-md-6 ">
                        <div class="card info-card revenue-card oe_card">
                    ...
                    <div class="col-xxl-4 col-xl-12">
                        ...
                        <div class="card info-card customers-card oe_card">
                    ...
                    <div class="col-12">
                        <div class="card recent-sales">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Property breakdown <span>| Year to date</span></h5>
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    <tr>
                                        <th scope="row"><a href="/property/{{$property->id}}">{{$property->name}}</a></th>
                                        <td><span class="badge bg-success">{{$property->property_type->name}}</span></td>
                                        <td><a href="#" class="text-primary">34 tonnes</a></td>
                                        <td>3.4 GWh</td>
                                        <td>2 mill litres</td>
                                    </tr>
                                        @endforeach
                    ...
                    <div class="col-12">
                        <div class="card top-selling">
                            ...
                            <div class="card-body pb-0">
                                <h5 class="card-title">Top metres <span>| Year to date</span></h5>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                    <tr>
                                        <th scope="row"><a href="#"><img src="assets/img/metres/water_sample.jpg" alt=""></a></th>
                                        <td><a href="#" class="text-primary fw-bold">Joburg Mall</a></td>
                                        <td><span class="badge badge-water">Water</span></td>
                                        <td class="fw-bold">100k litres</td>
                                        <td class="money">R 5,828</td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><a href="#"><img src="assets/img/metres/elect_sample.jpg" alt=""></a></th>
                                        <td><a href="#" class="text-primary fw-bold">Joburg Mall</a></td>
                                        <td><span class="badge bg-warning badge-electricity">Electric</span></td>
                                        <td class="fw-bold">980 kWh</td>
                                        <td class="money">R 34,508</td>
                                    </tr>
