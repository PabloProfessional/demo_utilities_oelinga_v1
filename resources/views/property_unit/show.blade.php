                   ...
                   <div class="row">
                           ...
                           <div class="card info-card sales-card ">
                               ...
                               <div class="card-body">
                                   ...
                                   <div class="d-flex align-items-center">
                                       ...
                                       <div class="ps-3">
                                           <h6>{{number_format($utility_total,2)}}</h6>
                       ...
                       <div class="col-xxl-4 col-md-6 oe_card">
                           <div class="card info-card sales-card">
                               ...
                               <div class="card-body">
                                   <h5 class="card-title">Tenant<span> | <a href="/user/{{$propertyUnit->tenant->user->id}}">{{$propertyUnit->tenant->user->name}}</a></span></h5>
                                   ...
                                   <div class="d-flex align-items-center">
                                       ...
                                       <div class="ps-3">
                                           <h6></h6>
                                           <span class="text-danger small pt-1 fw-bold"><a href="mailto:{{$propertyUnit->tenant->user->email}}">{{$propertyUnit->tenant->user->email}}</a> </span> <span class="text-muted small pt-2 ps-1">lease end date: <bold>12th Dec 2022</bold></span>
